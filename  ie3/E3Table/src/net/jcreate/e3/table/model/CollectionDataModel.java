...
public class CollectionDataModel extends AbstractDataModel{

	private final Collection datas ;
	private final Iterator datasIterator;
	
	public CollectionDataModel(Collection pDatas,SortInfo pSortInfo, PageInfo pNavInfo){
		...
		this.datasIterator = datas.iterator();
	}
	
	public CollectionDataModel(Collection pDatas){
		if ( pDatas == null ){
			this.datas = Collections.EMPTY_LIST;
		}else{
		    this.datas = pDatas;
